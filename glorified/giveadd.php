<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($num_rows>0)
        {
            $q = mysqli_query($con,"insert into giveadd(u_email,u_image,u_link,u_platform,u_description) VALUES 
			('{$email}','{$imagename}','{$link}','{$resource}','{$description}')") or die(mysqli_error($con));
			if($q){
	...
	<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form" action="" method="POST" enctype="multipart/form-data">
				...
				<div class="wrap-input100 validate-input m-b-20" data-validate="Enter username or email">
					<input class="input100" type="text" name="a_resource" placeholder="Company" required>
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input m-b-20" data-validate="Enter username or email">
					<input class="input100" type="text" name="a_description" placeholder="discription" required>
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input m-b-25" data-validate = "Enter password">
					<input class="input100" type="text" name="a_link" placeholder="Link For Ad">
					<span class="focus-input100"></span>
				</div>
                <br>
