<?php
	...
	$conadd2 = mysqli_query($con,"select * from giveadd") or die(mysqli_error($con));
	$num_add = mysqli_num_rows($conadd2);
	//$rowadd=mysqli_fetch_array($conadd);
	//$rowadd2=mysqli_fetch_array($conadd2);
?>
				...
				<div class="col-sm-12">
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<?php
								while($rowadd=mysqli_fetch_array($conadd)){
									if($rowadd["u_permission"]==1){	
							?>
							<div class="item active">
								<div class="col-sm-6">
										
									<h1><?php echo $rowadd["u_platform"]; ?></h1>
									<h2><?php echo $rowadd["u_description"]; ?></h2>
									<button type="button" class="btn btn-default get">Get it now</button>
								</div>
								<div class="col-sm-6">
									<img src="add/<?php echo $rowadd["u_image"]; ?>" alt="" width="350" height="230"/><!--<img src="images/home/pricing.png"  class="pricing" alt="" />-->
								</div>
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="add/<?php echo $rowadd["u_image"]; ?>" alt="" width="350" height="230"/>
